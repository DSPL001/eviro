...
import { editCollection } from 'slices/watchlist';
// ==============================|| SAMPLE PAGE ||============================== //

const EditWatchlistCollection = ({ show, close, info }) => {
                    ...
                    onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                        ...
                        try {
                            ...
                            if (scriptedRef.current) {   
                                dispatch(editCollection({ id, userId, watchlistCollectionName, watchlistCollectionDescription, watchlistCount }))
                                    .unwrap()
                                    .then(succ => {
                            ...
                            <Box sx={{ mt: 2 }}>
                                <AnimateButton>
                                    <LoadingButton
                                        ...
                                        size="large"
                                        loading={loading}
                                        loadingIndicator="Modifying Collection..."
                                        type="submit"
                                        variant="contained"
                                        color="secondary" >
                                        Edit Collection
...
EditWatchlistCollection.propTypes = {
    show: PropTypes.bool,
    close: PropTypes.func
}
export default EditWatchlistCollection;
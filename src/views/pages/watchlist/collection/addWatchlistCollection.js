...
import { addCollection } from 'slices/watchlist';

// ==============================|| SAMPLE PAGE ||============================== //

const AddWatchlistCollection = ({ show, close }) => {
    ...
    return (
        <Dialog fullScreen={fullScreen} open={show} onClose={close} aria-labelledby="responsive-dialog-title">
            ...
            <DialogContent>
                <Formik
                    initialValues={{
                        watchlistCollectionName: '',
                        watchlistCollectionDescription: '',                        
                        submit: null
                    }}
                    ...
                    onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                        ...
                        try {
                            ...
                            if (scriptedRef.current) {                                
                                dispatch(addCollection({ userId, watchlistCollectionName, watchlistCollectionDescription, watchlistCount }))
                                    .unwrap()
                                    .then(succ => {
...
AddWatchlistCollection.propTypes = {
    show: PropTypes.bool,
    close: PropTypes.func
}
export default AddWatchlistCollection;